...
{
public:
	SpinBox(const std::wstring &Name, Widget *parent = NULL);
	virtual ~SpinBox();
...
inline SpinBox &SpinBox_(const std::wstring &Name, Widget *parent = NULL)
{
...
#define SPINBOX(x)	static_cast<Gui::SpinBox*>(Gui::Widget::get(L""#x))
